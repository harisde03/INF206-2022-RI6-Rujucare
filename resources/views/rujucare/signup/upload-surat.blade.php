        ...
        <div class="d-flex align-items-center h-100">
            <div class="container-xl">
                ...
                <form action="/signup/upload-surat" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div
                            class="col d-flex align-items-center justify-content-center  @error('suratPernyataan') is-invalid @enderror">

                            <div class="col ">
                                <div class="drop-zone offset-md-2 ">
                                    <span class="drop-zone__prompt mb-2 col-10">
                                        <img src="{{ URL::asset("storage/" . 'assets/images/drop-file.png') }}" alt="Drop File Here"
