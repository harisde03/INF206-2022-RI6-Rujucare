...
@section('content')
        ...
        <div class ="container-xl " >
            ...
            <div class="boxes" id="boxes">
                ...
                <div class="buatRujukan " id="buatRujukan">
                    <div type="button"  >
                        <a href="{{URL('/admin/rujuk')}}" class="btn btn-rujukan btn-teal" >
        ...
        <div class="container-xl">
            ...
            <div class="boxes col-12 ">
                <ul class="flex-list d-flex flex-wrap ">
                    <li class="box ">
                        <div class="box-img center col-12 " id ="frame-image" style="background-image: url(assets/images/dokter1.png);background-size:cover;"">
                    ...
                    <li class="box ">
                        <div class="box-img center col-12" id ="frame-image"  style="background-image: url(assets/images/dokter2.png);background-size:cover;"">
    ...
    <div class="screen-info mb-5" id="screen-info">
        <div class="container-xl">
