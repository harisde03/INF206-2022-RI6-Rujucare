    ...
    <section class="container-xl mb-4 vh-90">
        <div class="d-flex align-items-center h-100">
            <div class="container-xl">
                <h1 class="d-flex justify-content-center">Pengajuan Surat Rujukan Kembali</h1>
                <p class="d-flex justify-content-center">Surat Pengajuan Kembali ke {{ $post->namaPublik }}</p>
                <br><br>
                <form method="POST" action="{{ route('rujukKembali.tolakRujukan') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col">
                            <input type="hidden" name="id_pesan_masuk" value="{{ $pesan->id_pesan_masuk }}">
                            ...
                            <div>
                                ...
                                <input name="nomorBpjs" type="text" class="form-control" placeholder="Nomor Kartu BPJS"
                                    value="{{ $pesan->nomorBpjs }}" disabled>
